...
export default function Trending ()  {
  ...
  return (
   <section className='container mx-auto px-5 py-5 flex flex-col gap-10 '>
    ...
    <TrendingCard img={Paperoni} bg="#E6F3F5"/>
    <TrendingCard img={PizzaMeat} bg="#E6F3F5"/>
    <TrendingCard img={DonerKebab} bg="#EAEEFA"/>
    <TrendingCard img={SalmonRoll} bg="#F9EEF3"/>
    <TrendingCard img={CupcakeChoco} bg="#F0FEEB"/>
    <TrendingCard img={DoughnutMilk} bg="#F3F7D9"/>
    <TrendingCard img={DoughnutUnicorn} bg="#F3F7D9"/>
    <TrendingCard img={KathiKebab} bg="#EAEEFA"/>
